...
// GitHub usernames contain only ASCII alphanumerics and hyphens, 1-39 chars. We validate ONLY to
// safely interpolate the login into a GraphQL query string (dates are generated by us, never user
// input) — so this is an injection guard, NOT GitHub's naming policy. We deliberately do NOT
// require the login to start/end alphanumeric: legacy grandfathered accounts (created before
// ~2013) end with a hyphen or contain double hyphens, e.g. "Link-", "gil--", "p-", and are real
// org members. This charset+length bound still blocks quotes, spaces, braces, etc.
